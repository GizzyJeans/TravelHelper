...
public class PlaceProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.travelhelper.PlaceProvider";
    ...
    String mKey = "key=AIzaSyAT5UaNBcIetPMNiThBY5aXi0VTcUa8dZE";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        case SUGGESTIONS :
            ...
            mCursor = new MatrixCursor(new String[] { "_id", SearchManager.SUGGEST_COLUMN_TEXT_1, SearchManager.SUGGEST_COLUMN_QUERY, SearchManager.SUGGEST_COLUMN_INTENT_EXTRA_DATA } );
            ...
            try {
                ...
                for(int i=0;i<list.size();i++){
                    ...
                    // Adding place details to cursor
                    mCursor.addRow(new String[] { Integer.toString(i), hMap.get("description"), hMap.get("description"), hMap.get("reference") });
                }
            } catch (JSONException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
        ...
        case DETAILS :
            // Defining a cursor object with columns description, lat and lng
            mCursor = new MatrixCursor(new String[] { "place","description","lat","lng" });
            ...
            for(int j=0;j<detailsList.size();j++){
                HashMap<String, String> hMapDetails = detailsList.get(j);
                mCursor.addRow(new String[]{ selectionArgs[1],hMapDetails.get("formatted_address") , hMapDetails.get("lat") , hMapDetails.get("lng") });
            }
            c = mCursor;
